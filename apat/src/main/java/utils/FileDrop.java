 ...
 * border.
 * <p/>
 * To use this class, construct a new <tt>utils.FileDrop</tt> by passing it the target
...
public class FileDrop {
                        ...
                        // this section will check for a com.googlecode.dex2jar.reader flavor.
                        {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    // );
                                    evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_COPY);
                                    log(out, "utils.FileDrop: com.googlecode.dex2jar.reader accepted.");
                            ...
                            if (!handled) {
                                log(out, "utils.FileDrop: not a file list or com.googlecode.dex2jar.reader - abort.");
                                evt.rejectDrop();
                            }
    ...
    private void makeDropTarget(final PrintStream out, final java.awt.Component c, boolean recursive) {
        ...
        try {
            ...
            e.printStackTrace();
            log(out,
                    "utils.FileDrop: Drop will not work due to previous error. Do you have another listener attached?");
        } // end catch
     ...
     * {@link File DropListener#filesDropped filesDropped(...)} method in your
     * {@link File DropListener} when files are dropped onto a registered drop
     * target.
     * <p/>
     * <p>
     * I'm releasing this code into the Public Domain. Enjoy.
