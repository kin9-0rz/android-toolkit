 ...
 * border.
 * <p/>
 * To use this class, construct a new <tt>gui.FileDrop</tt> by passing it the target
 * component and a <tt>Listener</tt> to receive notification when file(s) have
 * been dropped. Here is an example:
 * <p/>
 * <code><pre>
 *      JPanel myPanel = new JPanel();
 *      new gui.FileDrop( myPanel, new gui.FileDrop.Listener()
 *      {   public void filesDropped( java.io.File[] files )
 *          {
 *              // handle file drop
 *              ...
 *          }   // end filesDropped
 *      }); // end gui.FileDrop.Listener
 * </pre></code>
 * <p/>
...
public class FileDrop {
     ...
     * @since 1.0
     */
    public FileDrop(final PrintStream out, final java.awt.Component c, final Listener listener) {
        ...
        if (supportsDnD()) { // Make a drop listener
            dropListener = new java.awt.dnd.DropTargetListener() {
                public void dragEnter(java.awt.dnd.DropTargetDragEvent evt) {
                    log(out, "gui.FileDrop: dragEnter event.");
                    ...
                    if (isDragOk(out, evt)) {
                        ...
                        if (c instanceof javax.swing.JComponent) {
                            ...
                            log(out, "gui.FileDrop: normal border saved.");
                            jc.setBorder(dragBorder);
                            log(out, "gui.FileDrop: drag border set.");
                        } // end if: JComponent
                        ...
                        log(out, "gui.FileDrop: event accepted.");
                    } // end if: drag ok
                    else { // Reject the drag event
                        evt.rejectDrag();
                        log(out, "gui.FileDrop: event rejected.");
                ...
                public void drop(java.awt.dnd.DropTargetDropEvent evt) {
                    log(out, "gui.FileDrop: drop event.");
                    try { // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                            ...
                            log(out, "gui.FileDrop: file list accepted.");
                            ...
                            log(out, "gui.FileDrop: drop complete.");
                        } // end if: file list
                        else
                        // this section will check for a com.googlecode.dex2jar.reader flavor.
                        {
                            // Thanks, Nathan!
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    // );
                                    evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_COPY);
                                    log(out, "gui.FileDrop: com.googlecode.dex2jar.reader accepted.");
                            ...
                            if (!handled) {
                                log(out, "gui.FileDrop: not a file list or com.googlecode.dex2jar.reader - abort.");
                                evt.rejectDrop();
                            }
                        ...
                        log(out, "gui.FileDrop: IOException - abort:");
                        io.printStackTrace(out);
                        evt.rejectDrop();
                    } // end catch IOException
                    catch (java.awt.datatransfer.UnsupportedFlavorException ufe) {
                        log(out, "gui.FileDrop: UnsupportedFlavorException - abort:");
                        ...
                        if (c instanceof javax.swing.JComponent) {
                            ...
                            log(out, "gui.FileDrop: normal border restored.");
                        } // end if: JComponent
                    } // end finally
                } // end drop

                public void dragExit(java.awt.dnd.DropTargetEvent evt) {
                    log(out, "gui.FileDrop: dragExit event.");
                    // If it's a Swing component, reset its border
                    if (c instanceof javax.swing.JComponent) {
                        javax.swing.JComponent jc = (javax.swing.JComponent) c;
                        jc.setBorder(normalBorder);
                ...
                public void dropActionChanged(java.awt.dnd.DropTargetDragEvent evt) {
                    log(out, "gui.FileDrop: dropActionChanged event.");
                    // Is this an acceptable drag event?
            ...
            log(out, "gui.FileDrop: Drag and drop is not supported with this JVM");
    ...
    private static File[] createFileArray(BufferedReader bReader, PrintStream out) {
        try {
            ...
            while ((line = bReader.readLine()) != null) {
                try {
                    // kde seems to append a 0 char to the end of the com.googlecode.dex2jar.reader
            ...
            log(out, "gui.FileDrop: IOException");
        }
        return new File[0];
    }
    ...
    private void makeDropTarget(final PrintStream out, final java.awt.Component c, boolean recursive) {
        ...
        try {
            ...
            e.printStackTrace();
            log(out,
                    "gui.FileDrop: Drop will not work due to previous error. Do you have another listener attached?");
        } // end catch
        ...
        c.addHierarchyListener(new java.awt.event.HierarchyListener() {
            public void hierarchyChanged(java.awt.event.HierarchyEvent evt) {
                log(out, "gui.FileDrop: Hierarchy changed.");
                java.awt.Component parent = c.getParent();
                if (parent == null) {
                    c.setDropTarget(null);
                    log(out, "gui.FileDrop: Drop target cleared from component.");
                } // end if: null parent
                else {
                    new java.awt.dnd.DropTarget(c, dropListener);
                    log(out, "gui.FileDrop: Drop target added to component.");
    ...
    private boolean isDragOk(final PrintStream out, final java.awt.dnd.DropTargetDragEvent evt) {
        ...
        if (out != null) {
            if (flavors.length == 0)
                log(out, "gui.FileDrop: no data flavors.");
    ...
    public static boolean remove(PrintStream out, java.awt.Component c, boolean recursive) { // Make sure we support dnd.
        if (supportsDnD()) {
            log(out, "gui.FileDrop: Removing drag-and-drop hooks.");
            c.setDropTarget(null);
            if (recursive && (c instanceof java.awt.Container)) {
     ...
     *      public class MyClass implements gui.FileDrop.Listener
     *      ...
     *      public void filesDropped( java.io.File[] files )
     *      {
     *          ...
     ...
     * {@link java.io.File DropListener#filesDropped filesDropped(...)} method in your
     * {@link java.io.File DropListener} when files are dropped onto a registered drop
     * target.
     * <p/>
     * <p>
     * I'm releasing this code into the Public Domain. Enjoy.
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable {
         ...
         * @since 1.1
         */
        public final static DataFlavor DATA_FLAVOR = new DataFlavor(FileDrop.TransferableObject.class,
                MIME_TYPE);
         ...
         * <tt>application/x-net.iharder.dnd.TransferableObject</tt>.
         *
         * @param dataClass The {@link Class} to use in the custom data
         *                  flavor
         * @param fetcher   The {@link Fetcher} that will return the data object
         * @see Fetcher
         * @since 1.1
         ...
         */
        public Object
        getTransferData(DataFlavor flavor) throws java.awt.datatransfer.UnsupportedFlavorException,
                IOException {
            // Native object
